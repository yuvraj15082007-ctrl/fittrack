...
export default function FitTrack() {
  ...
  const s = {
    ...
    input: {
      ...
      borderRadius: 10, padding: "12px 16px", color: theme.text,
      fontSize: 16, width: "100%", fontFamily: "'Rajdhani', sans-serif"
    },
    nav: {
    ...
    navBtn: (active) => ({
      ...
      alignItems: "center", gap: 2, fontSize: 10,
      fontWeight: 700, letterSpacing: 1, padding: "4px 12px"
    }),
    ...
    <div style={{ padding: "0 16px", animation: "fadeIn .3s ease" }}>
      ...
      <div style={{ ...s.card, height: 180, padding: 8, position: "relative" }}>
        ...
        {trackState === "paused" && isAutoPaused && (
          <div style={{
            position: "absolute", top: 14, right: 14,
            background: theme.warn, color: "#000",
        ...
        {trackState === "paused" && isAutoPaused && (
          <div style={{ flex: 1, display: "flex", flexDirection: "column", gap: 8 }}>
            <div style={{
              ...
              border: `1px solid ${theme.warn}50`,
              borderRadius: 10, padding: "10px 14px",
              textAlign: "center", color: theme.warn,
    ...
    <div style={{ padding: "0 16px", animation: "fadeIn .3s ease" }}>
      ...
      <div style={s.card}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div
            onClick={() => { setDarkMode(!darkMode); save("ft_dark", !darkMode); }}
            style={{
              width: 50, height: 28, borderRadius: 14,
              background: darkMode ? theme.accent : theme.surface,
      ...
      <div style={s.wrap}>
        ...
        {notification && (
          <div style={{
            ...
            background: notification.type === "success" ? theme.accent
              : notification.type === "warn" ? theme.warn
